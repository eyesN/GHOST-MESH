...
export default function App() {
    ...
    return (
        <div className={`relative h-screen w-full overflow-hidden font-sans ${isDarkMode ? 'dark' : ''}`}>
            {/* Global Theme Toggle Button */}
            <button
                onClick={() => setIsDarkMode(!isDarkMode)}
                className="absolute top-4 right-4 z-[100] p-2 rounded-full bg-slate-800 text-white shadow-lg hover:scale-105 transition-transform duration-200"
